...
const RandomPlanetView = ({ planet }) => {
   ...
   const { id, name, population, diameter, rotationPeriod, climate, terrain } = planet

   return (
      <React.Fragment>
         <div div className="img"> <img src={`https://starwars-visualguide.com/assets/img/planets/${id}.jpg`} alt={name} /></div >
